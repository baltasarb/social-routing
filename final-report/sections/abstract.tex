...
To application is structured in two major components, one with the front end, the Social Routing Client
...
aid of an externa API being the SRS responsible for the generation of user credentials.
