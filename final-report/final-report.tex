...
\title{
    ...
    \textsc{\Large Final Report - Project and Seminar}\\[0.5cm]
    \begin{figure}[ht]            
        \includegraphics[width=\textwidth]{logo_ISEL_principal_Preto_RGB_300ppi.jpg}
    \end{figure}  
...
\begin{document}     
    ...
    \input{sections/authentication.tex}
    \newpage
