...
@Component
class PersonRepositoryImplementation(private val connectionManager: ConnectionManager, private val mapper: PersonMapper, private val routeMapper: RouteMapper) : PersonRepository {
